...
var Day = function Day(_ref) {
  ...
  return _react2.default.createElement(
    _Tile2.default,
    _extends({}, otherProps, {
      classes: [].concat(_toConsumableArray(classes), [className + appendTodayClassNameIfNeeded(date), (0, _dates.isWeekend)(date) ? className + '--weekend' : null, date.getMonth() !== currentMonthIndex ? className + '--neighboringMonth not' : null]),
      date: date,

import { mergeFunctions, isValueWithinRange, isRangeWithinRange, doRangesOverlap, between, getTileClasses } from "../utils";
...
describe("getTileClasses", () => {
	...
	it("throws an error when given value but not given other parameters ", () => {
		expect(() => getTileClasses({ value: new Date(2017, 0, 1) })).toThrow();
	});

...
export const formatDate = (date, locale) => getFormatter({ day: "numeric", month: "numeric", year: "numeric" }, locale)(toSafeHour(date));

export const formatMonthYear = (date, locale) => getFormatter({ month: "long", year: "numeric" }, locale)(toSafeHour(date));

export const formatMonth = (date, locale) => getFormatter({ month: "long" }, locale)(toSafeHour(date));

export const formatShortWeekday = (date, locale) => getFormatter({ weekday: "short" }, locale)(toSafeHour(date));

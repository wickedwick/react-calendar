...
export const getCenturyRange = date => [getBeginOfCentury(date), getEndOfCentury(date)];
...
export const getDecadeRange = date => [getBeginOfDecade(date), getEndOfDecade(date)];
 ...
 * @param {Date} date Date.
 */
export const getYearRange = date => [getBeginOfYear(date), getEndOfYear(date)];
 ...
 * @param {Date} date Date.
 */
export const getMonthRange = date => [getBeginOfMonth(date), getEndOfMonth(date)];
 ...
 * @param {Date} date Date.
 */
export const getDayRange = date => [getBeginOfDay(date), getEndOfDay(date)];
